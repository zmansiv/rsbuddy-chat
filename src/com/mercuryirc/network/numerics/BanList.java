...
public class BanList implements Connection.NumericHandler {
	...
	public void process(Connection connection, String line, String[] parts) {
		...
		InputCallback callback = connection.getInputCallback();
		...
		if (num == 367 || num == 346 || num == 348) {
			...
			case 368:
				callback.onChannelModeList(connection, channel, Mode.Type.BAN, channel.getBans());
				break;
			case 347:
				callback.onChannelModeList(connection, channel, Mode.Type.INVITE, channel.getInvites());
				break;
			case 349:
				callback.onChannelModeList(connection, channel, Mode.Type.EXCEPT, channel.getExcepts());
				break;
		}
	}
