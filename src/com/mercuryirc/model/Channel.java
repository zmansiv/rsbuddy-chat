...
public class Channel implements Entity {
	...
	private ReadOnlySetWrapper<User> users = new ReadOnlySetWrapper<>(FXCollections.observableSet(new HashSet<User>()));
	...
	public ReadOnlySetProperty<User> getUsersProperty() {
		return users;
	}
